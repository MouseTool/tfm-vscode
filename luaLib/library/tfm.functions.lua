...
--- @param options table fixedXSpeed (Number), fixedYSpeed (Number)
...
--- @param speed? number Balloon speed. (default `1`)
...
--- @param displayIce? boolean Display or not ice on the mouse. (default `true`)
